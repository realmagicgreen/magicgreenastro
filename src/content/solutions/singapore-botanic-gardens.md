...
{% assign name = '-02' %} {% include 'partials/image.html', name: 'name', caption: 'Victoria Amazonica - Giant water lilies' %}
...
{% assign name = '-04' %} {% include 'partials/image.html', name: 'name', caption: 'Artemisia, the ancient, and still the best, cure for Malaria.' %}
...
{% assign name = '-03' %} {% include 'partials/image.html', name: 'name', caption: 'Ficus Kerkhovenii at Singapore botanic gardens' %}
...
{% assign name = '' %} {% include 'partials/image.html', name: 'name', caption: 'Singapore botanic gardens' %}
...
{% assign name = '-08' %} {% include 'partials/image.html', name: 'name', caption: 'Singapore botanic gardens' %}
...
{% assign name = '-07' %} {% include 'partials/image.html', name: 'name', caption: 'Singapore botanic gardens' %}
...
{% assign name = '-06' %} {% include 'partials/image.html', name: 'name', caption: 'Singapore botanic gardens' %}
...
{% assign name = '-05' %} {% include 'partials/image.html', name: 'name', caption: 'Singapore botanic gardens' %}
